...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for dist in livingGhostPositionDistributions:
            curPosition = dist.argMax()
            curDistance = self.distancer.getDistance(pacmanPosition, curPosition)
            if minDistance > curDistance:
                minDistance = curDistance
                ghostPosition = curPosition

        action = None
        for a in legal:
            succ = Actions.getSuccessor(pacmanPosition, a)
            succDistance = self.distancer.getDistance(succ, ghostPosition)
