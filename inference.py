...
class DiscreteDistribution(dict):
    ...
    def sample(self):
        ...
        values = [pair[1] for pair in items]
        
        index = 0
        totalDist = values[0]
        rand = random.random()
        
        while rand > totalDist:
            index += 1
            totalDist += values[index]
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for pos in self.allPositions:
            ...
            discreteDistribution[pos] =  observationProb * self.beliefs[pos]
    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            ...
            for newPos in newPosDist.keys():
                discreteDistribution[newPos] += oldProb * newPosDist[newPos]
